...
Keep this document focused on how to answer the user. Do not store repository architecture facts, API behavior, implementation notes, or package-specific details here. Put those in the relevant `knowledge/*` document instead.
